...
(define (myeval exp env)
  ...
  (cond
    ...
    [(let? exp) 
      ;(display (list 'let (let->combination exp))) (newline)
      (myeval (let->combination exp) env)]
    
    [(while? exp)
      ;(display (list 'while (while->proc exp))) (newline)
      (myeval (while->proc exp) env)]
...
(define (myapply procedure arguments)
  (cond
    ...
    [(compound-procedure? procedure)
      ;(display (list 'Applying procedure arguments)) (newline)
      (myeval-sequence
